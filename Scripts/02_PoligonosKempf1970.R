#-------------------------------------------------------#
#Rhodolith polygons of Kempf (1970), after Kempf (1968)##
#-------------------------------------------------------#
...
#criando data.frame para poligono Recife
lon <- c(-34.767, -34.543, -34.744, -34.89, -34.84, -34.767, -34.722)
lat <- c(-8, -8, -8.41, -8.41, -8.141, -8.159, -8.018) 
